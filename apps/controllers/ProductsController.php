    ...
    */
    ...
    public function typeAction($id = null)
    {
        ...
        if ($input->hasPost('btnSubmit') == true) {
            ...
            if ($validator->run()) {
                ...
                if ($product->save()) {
                    $this->setFlash('success', 'Product saved successfully!')->redirectTo('products/index/'.Url::segment(4));
    ...
    public function deleteAction($id)
    {
        ...
        if ($product->trash($id) == true) {
            ...
            Url::setFlash('error', 'Error Occured while deleting Product!')->redirectTo('products/');
        }
    }
