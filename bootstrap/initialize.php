...
/*
 ...
 |-------------------------------------------------------------------
 |
 | To boot framework first thing we will create a new application
 | instance which serves glue for all the components, and binding
 | components with the IoC container.
*/
