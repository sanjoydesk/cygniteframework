...
class CF_BaseSession
{
    ...
    private $sess_val = NULL;
                    ...
                    */
                    ...
                    {
                                // Cygnite::loader()->request('Encrypt',CF_ENCRYPT_KEY);
                                 $this->config = Config::getconfig('session_config');
                                 unset($config);
                             ...
                             $callee = debug_backtrace();
                                    switch ($value):
                                        ...
                                        case is_string($value):
                                                     if(!empty($key)):
                                                          $_SESSION[$key]= Cygnite::loader()->request('Encrypt',CF_ENCRYPT_KEY)->encrypt($value);
                                                          return TRUE;
                                                    else:
                    ...
                    public function getsession($key,$defaultValue=NULL)
                    {
                                 switch ($key):
                                        ...
                                        case is_string($_SESSION[$key]):
                                                        return  isset($_SESSION[$key]) ? Cygnite::loader()->request('Encrypt',CF_ENCRYPT_KEY)->decrypt($_SESSION[$key]) : $defaultValue;
                                            break;
                                   endswitch;
