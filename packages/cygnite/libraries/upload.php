...
class Upload
{
    ...
    private function uploadFile()
    {
        ...
        if (!(isset($this->_fileRequirements['falses']['upload_path'])
            && !empty($this->_fileRequirements['falses']['upload_path']))
        ) {
        ...
        if ($this->_fileRequirements['file']['size'] <=
            $this->getNumericfileSize($this->_fileRequirements['size'])
        ) {
            $path = getcwd().$this->_fileRequirements['falses']['upload_path'].'/'.$this->_fileRequirements['file']['name'];
    ...
    public function __call($function, $arguments)
    {
        ...
        if (isset($arguments[0])
            ...
            $this->_fileRequirements['falses'] = $arguments[0];
        }
