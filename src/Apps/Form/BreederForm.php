...
class BreederForm extends Form
{
    ...
    */
    ...
    public function buildForm()
    {
        ...
        $this->open("", array(
        "method" => "post", "id"     => "uniform", "role"   => "form", "action" => Url::sitePath("/$this->action/$id/"),
		...
		->addElement("label", "Address", array("class" => "col-sm-2 control-label","style" => "width:100%;"))
		->addElement("text", "address", array("value" => (isset($this->model->address)) ? $this->model->address : "", "class" => "form-control"))
		->addElement("label", "State", array("class" => "col-sm-2 control-label","style" => "width:100%;"))
		->addElement("text", "state", array("value" => (isset($this->model->state)) ? $this->model->state : "", "class" => "form-control"))
		->addElement("label", "City", array("class" => "col-sm-2 control-label","style" => "width:100%;"))
		->addElement("text", "city", array("value" => (isset($this->model->city)) ? $this->model->city : "", "class" => "form-control"))
		->addElement("label", "Phone", array("class" => "col-sm-2 control-label","style" => "width:100%;"))
		->addElement("text", "phone", array("value" => (isset($this->model->phone)) ? $this->model->phone : "", "class" => "form-control"))
